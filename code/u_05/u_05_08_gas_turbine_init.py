...
using turbine inlet temperature as the classic 
approach to define the operation of
diabatic combustion chamber 
after inititialization with stored data
belongs to
...
#solve with starting values from stable results
gt.solve(mode='design', init_path='code/u_05/gt_stable.json')
#for older versions of tespy
#gt.solve(mode='design', init_path='code/u_05/gt_stable_results/')
