...
# c02 = Connection(hpt, 'out1', lpt, 'in1', 'c02')
c02 = Connection(hpt, 'out1', ext, 'in1', 'c02')
c03 = Connection(ext, 'out1', lpt, 'in1', 'c03')
# c04 = Connection(lpt, 'out1', con, 'in1', 'c04')
...
n = 200
p_range = np.linspace(20, 1, n)
etas = np.empty([n])
i=0
for p in p_range:
    c02.set_attr(p=p)
    plant.solve(mode='design')
    etas[i] = abs(hpt.get_attr('P').val + lpt.get_attr('P').val)/stg.get_attr('Q').val
    i +=1
