"""
Script to calculate the power output of an
air turbine that expands air at ambient temperature
from an elevated to ambient pressure
...
c1.set_attr(m=1, fluid={"air": 1}, T=20, p=10)
c2.set_attr(p=1)

turbine.set_attr(eta_s=0.9)

nw.solve("design")
print(turbine.get_attr('P').val)
