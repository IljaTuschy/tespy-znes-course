"""
Script for calculating the duty of a
heater that heats up a certain mass flow
of air to a defined temperature
...
c2.set_attr(T=363.15)

heater.set_attr(pr=0.9)

nw.solve("design")
print(heater.get_attr('Q').val)
